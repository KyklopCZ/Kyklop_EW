...
#include "\idi\acre\addons\sys_signal\script_component.hpp"	//The "\idi\acre\addons\sys_signal" part wasn't done by ACRE2Team, but was necessary for this reference to work
/*
 * Author: ACRE2Team
...
//if (!isNil QGVAR(customSignalFunc)) exitWith { _this call GVAR(customSignalFunc); };	This comment wasn't done by ACRE2TEAM, but was necessary to not create infinite loop
...
if(_jammingSignalStrength == 0) exitWith { hint _debug; [_Px, _maxSignal]; };
